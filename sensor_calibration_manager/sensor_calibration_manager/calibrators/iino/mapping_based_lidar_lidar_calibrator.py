...
@CalibratorRegistry.register_calibrator(
    project_name="iino", calibrator_name="mapping_based_lidar_lidar_calibrator"
)
class MappingBasedLidarLidarCalibrator(CalibratorBase):
    ...
    def __init__(self, ros_interface: RosInterface, **kwargs):
        ...
        self.calibration_lidar_frames = ["velodyne_rear"]

        self.required_frames.extend(
            [self.mapping_lidar_frame, *self.calibration_lidar_frames]
        )
